        ...
        <aside className="w-80 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              />
              <span className="block text-xs text-muted-foreground leading-relaxed">Valores mais altos tendem deixar o resultado mais criativo e com possíveis erros. </span>
            </div>
