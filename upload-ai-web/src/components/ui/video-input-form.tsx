...
export function VideoInputForm(props: VideoInputFromProps) {
  ...
  function handFileSelected(event: ChangeEvent<HTMLInputElement>) {
  ...
  return (
        <form onSubmit={handleUploadVideo} className="space-y-6">
            ...
            <input type="file" id="video" accept="video/mp4"  className="sr-only" onChange={handFileSelected}/>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                ...
                placeholder="Inclua palavras-chaves mencionadas no vídeo separadas por vígulas (,)"/>
            </div>
            <Button 
